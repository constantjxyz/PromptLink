...
file_dir = 'dataset/cradle_ibkh/snomed/embedding/ada2/embedding.npz'
save_excel, save_prediction = '', ''
...
# edit distance
# mention_predictions, prediction_values = generate_predictions_levenshtein(mentions, concepts, query_idxs=experiment_ids, k=100,)
# jw distance
mention_predictions, prediction_values = generate_predictions_jaro_winkler(mentions, concepts, query_idxs=experiment_ids, k=100,)
# Smith waterman similarity
# mention_predictions, prediction_values = generate_predictions_smith_waterman(mentions, concepts, query_idxs=experiment_ids, k=100,)
